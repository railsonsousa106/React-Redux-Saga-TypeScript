...
export const InlinetooltipWrapper = styled.div`
  ...
  &.is-scaled {
    ...
    .control {
            -webkit-transition: -webkit-${props => props.theme.tooltip_backward_transition}, ${props =>
  props.theme.tooltip_default_transition};
              transition: ${props => props.theme.tooltip_backward_transition}, ${props =>
  props.theme.tooltip_default_transition};
    ...
    &.scale {
       ...
       -webkit-transform: scale(0);
           -ms-transform: scale(0);
               transform: scale(0);
      -webkit-transition: -webkit-${props => props.theme.tooltip_forward_transition}, ${props =>
  props.theme.tooltip_default_transition};
              transition: ${props => props.theme.tooltip_forward_transition}, ${props =>
  props.theme.tooltip_default_transition};
    ...
    &.video {
      background-color: ${props => props.theme.tooltip_video};
      border-color: ${props => props.theme.tooltip_video};
    ...
    &.image {
      background-color: ${props => props.theme.tooltip_image};
      border-color: ${props => props.theme.tooltip_image};
    ...
    &.divider {
      background-color: ${props => props.theme.tooltip_divider};
      border-color: ${props => props.theme.tooltip_divider};
