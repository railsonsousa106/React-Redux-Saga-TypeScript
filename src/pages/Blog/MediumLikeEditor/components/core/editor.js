...
export default class DanteEditor extends React.Component {
  ...
  initializeState = () => {
    ...
    if (this.props.content) {
      newEditorState = EditorState.set(this.decodeEditorContent(this.props.content), {
  ...
  onChange = editorState => {
    ...
    this.setState({ editorState }, () => {
      ...
      return this.props.onChange ? this.props.onChange(this) : null;
    });
  };
  ...
  handleUndeletables = editorState => {
    ...
    const undeletable_types = this.props.widgets
      .filter(function (o) {
    ...
    const undeletablesMap = blockMap.filter(function (o) {
  ...
  defaultWrappers = blockType => {
    return this.props.default_wrappers
      .filter(o => {
  ...
  render() {
    return (
      <div suppressContentEditableWarning={true}>
        ...
        {this.props.debug ? <Debug locks={this.state.locks} editor={this} /> : undefined}
