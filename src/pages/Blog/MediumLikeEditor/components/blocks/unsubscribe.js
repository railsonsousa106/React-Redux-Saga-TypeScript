...
export default class UnsubscribeBlock extends React.Component {
  ...
  handleClickOutside(event) {
    if (
      this.wrapperRef &&
      this.wrapperRef.refs.btn &&
      !this.wrapperRef.refs.btn.contains(event.target) &&
          ...
          <div className="content-elements">
            <div className="input-group">
              <span className="input-group-addon" id="link">
                <img className="link" src={'images/icons/link.svg'} />
              </span>
              <input
            ...
            <div className="input-group text-style">
              <div className="input-group-btn">
                <div className="btn-group">
                  ...
                  <ul aria-labelledby="button-font-color" className="dropdown-menu color-picker">
                    <li>
                      <SketchPicker
