...
import { addNewBlockAt } from '../../model/index.js';
...
export default class ButtonBlock extends React.Component {
  ...
  setPosition = direction => {
    switch (direction) {
      case 'left':
        return Object.assign({}, this.state.containerStyle, {
          textAlign: 'left',
        });
        break;
      case 'right':
    ...
    if (this.props.block.text.length === 0) {
      return (
        <div className="public-DraftEditorPlaceholder-root">
          <div className="public-DraftEditorPlaceholder-inner">{'write something'}</div>
        </div>
      );
    }
  };
  ...
  render = () => {
    ...
    return (
      <div style={{ width: '100%', margin: '18px 0px 47px 0px' }}>
        <div ref={this.setWrapperRef} style={this.state.containerStyle}>
          <Manager>
            <Reference>
              {({ ref }) => (
                <a
            ...
            {this.state.displayPopOver ? (
              <Popper placement="top">
                {({ ref, style, placement, arrowProps }) => (
                  <div ref={ref} style={style} className="dante--popover" data-placement={placement}>
                    <h3 className="popover-title">Popper element</h3>
    ...
    return (
      <div className="popover-content" contenteditable="false">
        ...
        >
          ...
          >
            <svg className="svgIcon-use" height="19" viewBox="0 0 19 19" width="19">
              <path
          ...
          <div className="edit">
            <div className="content-elements">
              <div className="input-group">
                <span className="input-group-addon" id="link">
                  {link()}
                </span>
                <input
            ...
            <div className="design-settings">
              <div aria-label="..." className="btn-group btn-group-justified" id="button-align" role="group">
              ...
              <div aria-label="..." className="btn-group btn-group-justified" id="button-corners" role="group">
                <div className="btn-group" role="group">
                  <button
              ...
              <div aria-label="..." className="btn-group btn-group-justified" id="button-fill" role="group">
                <div className="btn-group" role="group">
                  <button
                ...
                <div className="input-group-btn">
                  ...
                  <div className="btn-group">
                    <Dropdown
                      ...
                      target={ctx => {
                        return (
                          <ul aria-labelledby="button-font-size" className="dropdown-menu">
                  ...
                  trigger={ctx => {
                    return (
                      <button
                        ...
                        type="button"
                      >
                        <span className="selected">{this.props.buttonStyle.fontFamily}</span>
                        <span className="caret" />
                      </button>
                    );
                  }}
                ...
                <div className="input-group-btn">
                  <div className="btn-group">
                    <button
                      ...
                      onClick={e => {
                        this.setState({
                          buttonColorPicker: !this.state.buttonColorPicker,
                        });
                      }}
                      type="button"
                    >
...
class Dropdown extends Component {
  ...
  render() {
    return (
      <div className="dropdown font-select" ref={'el'} style={{ float: 'none' }}>
