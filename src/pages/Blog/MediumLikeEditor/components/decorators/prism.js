...
const defaultRender = props => {
  return React.createElement('span', { className: 'prism-token token ' + props.type }, props.children);
};
...
export const PrismDraftDecorator = (options = {}) => new PrismDecorator(Object.assign(options, PrismOptions));
